...
if __name__ == '__main__':
    ...
    start_neurons = 16
    path1 = '/home/mainak/Desktop/kaggle/TGS SALT/test/images/'
    ...
    model.load_weights("/home/mainak/Desktop/kaggle/TGS SALT/Unet2.hdf5")
    path2 = '/home/mainak/Desktop/kaggle/TGS SALT/result_mask_2/'
    n_classes = 2
    ...
    dp = {}
    with open('/home/mainak/Desktop/kaggle/TGS SALT/dp', 'rb') as f:
        dp = pickle.load(f)
    names = []
    img = []
    for image in listing:
        ...
        names.append(name)
        #break
    make_submission(img, names, fast=False, path='result2.csv')
